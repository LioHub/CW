...
def send_message(chat_id, text):
    try:
        mes_id = requests.get("https://api.telegram.org/bot815857616:AAEr4VJ0XQ1QyTPb0jvVeUg-POgO6_uWsO4/sendMessage",
...
def editMessageText(chat_id, text):
    try:
        ...
        try:
            ...
            print(e)
        requests.get("https://api.telegram.org/bot815857616:AAEr4VJ0XQ1QyTPb0jvVeUg-POgO6_uWsO4/editMessageText",
...
def notic_about_payment(chat_id, text):
    try:
        ...
        #              params={"chat_id": chat_id, "text": text})
        requests.get("https://api.telegram.org/bot815857616:AAEr4VJ0XQ1QyTPb0jvVeUg-POgO6_uWsO4/sendMessage",
                     params={"chat_id": chat_id, "text": text})
    except requests.HTTPError as e:
        print('ERROR')
